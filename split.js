  ...
  ffmpeg.ffprobe(file, function(err, metadata) {
    ...
    if (duration > maxLength) {
      ...
      for(var i =0; i<duration; i+=maxLength){
        ...
        //file name for clips 
        //TODO: extension needs to be passed as param
        //Or use same extension as file being put in. using path lib.
        var filePart = path.join(tmpFolder, fileName + '.' + i + '.flac');
        //trim audio files 
        trimmer.trim({
          src: file,
          input: i,
